...
function Logo() {
  return (
    <svg fill="currentColor" width="122" height="40" viewBox="0 0 122 40" xmlns="http://www.w3.org/2000/svg" aria-labelledby='svg-title svg-description' role='img'>
      <title id="svg-title">Logo de Kasa</title>
      <desc id="svg-description">Logo de Kasa</desc>
      <path d="M11.6445 20.0984L5.12785 26.762V36.1125H0V0H5.12785V20.2058L24.5709 0H30.4466L15.1699 16.2292L31.5149 36.1125H25.5324L11.6445 20.0984Z" />
      ...
      <path d="M53.0946 28.9118V36.2203L56.1927 34.3932V27.0847L53.0946 28.9118Z" />
      <path d="M61.641 19.991L48.9282 12.575L41.8774 8.49084L34.9335 20.6358L35.0403 32.0285L47.6462 39.4445L48.9282 38.6921V27.9443L54.5902 17.9489L60.359 21.2807V32.0285L61.641 31.2761V19.991Z" />
    </svg>
  );
}
